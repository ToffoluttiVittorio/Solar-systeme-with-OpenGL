...
Object::Object(std::string path, std::string texturePath,double semiMajorAxis, double eccentricity, double angularVelocity):scale(1.0f),semiMajorAxis(semiMajorAxis),eccentricity(eccentricity),angularVelocity(angularVelocity) {
...
VertexBuffer Object::getNormals(){
    return *m_normalsb;
}
